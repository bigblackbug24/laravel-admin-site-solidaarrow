 ...
 <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ url ('') }}">Solid Arrow Admin Panel</a>
            </div>
            <!-- /.navbar-header -->
                    ...
                    <ul class="nav" id="side-menu">
                       ...
                       <li>
                        ...
                        <li {{ (Request::is('*table') ? 'class="active"' : '') }}>
                            <a href="{{ url ('user') }}"><i class="fa fa-table fa-fw"></i>View Users</a>
                        </li>
                        <li {{ (Request::is('*adduser') ? 'class="active"' : '') }}>
                            <a href="{{ url ('adduser') }}"><i class="fa fa-table fa-fw"></i> Add User</a>
                        </li>
                            </ul>
                        <li {{ (Request::is('*messages') ? 'class="active"' : '') }}>
                            <a href="{{ url ('messages') }}"><i class="fa fa-table fa-fw"></i> messages</a>
                        </li>
                       ...
                       <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li {{ (Request::is('*product-list') ? 'class="active"' : '') }}>
